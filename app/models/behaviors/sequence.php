...
class SequenceBehavior extends ModelBehavior {
  ...
  public function beforeSave(&$model) {
    ...
    // Editing
      ...
      && $this->isEqual($this->_newGroups[$model->alias], $this->_oldGroups[$model->alias])) {
        return;
      }

      // If changing group
      if ($this->_newGroups[$model->alias] && !$this->isEqual($this->_newGroups[$model->alias], $this->_oldGroups[$model->alias])) {
